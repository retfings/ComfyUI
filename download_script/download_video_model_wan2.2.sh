...
# =============================================================================
declare -A DOWNLOADS=(
    ["diffusion_models"]="https://modelscope.cn/models/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/master/split_files/diffusion_models/wan2.2_ti2v_5B_fp16.safetensors|${BASE_DIR}/diffusion_models|wan2.2_ti2v_5B_fp16.safetensors"
    ["vae"]="https://modelscope.cn/models/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/master/split_files/vae/wan2.2_vae.safetensors|${BASE_DIR}/vae|wan2.2_vae.safetensors"
